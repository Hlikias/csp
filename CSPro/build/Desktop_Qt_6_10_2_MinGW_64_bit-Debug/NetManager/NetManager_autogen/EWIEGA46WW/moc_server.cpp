...
void ClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->disconnected((*reinterpret_cast<std::add_pointer_t<qintptr>>(_a[1]))); break;
        ...
        case 5: _t->onHeartbeatTimeout(); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ClientHandler::*)(qintptr )>(_a, &ClientHandler::disconnected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ClientHandler::*)()>(_a, &ClientHandler::dataReceived, 1))
            return;
    }
}
...
// SIGNAL 0
void ClientHandler::disconnected(qintptr _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ClientHandler::dataReceived()
{
